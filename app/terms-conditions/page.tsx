    ...
    <div className="section-wrapper" style={{ minHeight: "80vh", paddingTop: "120px" }}>
      <div style={{ margin: "0 auto", width: "100%", maxWidth: "800px" }}>
        ...
        <div className="policy-content">
          ...
          <h3>Governing Law</h3>
          <p>These terms and conditions are governed by and construed in accordance with the laws of the jurisdiction in which Unyra operates, and you irrevocably submit to the exclusive jurisdiction of the courts in that location.</p>

          <h3>Intellectual Property Rights</h3>
          <p>All content on this website, including text, graphics, logos, images, and software, is the property of Unyra or its content suppliers and is protected by international copyright laws. Unauthorized use is prohibited.</p>
        </div>
      </div>
    </div>
  );
